...
$id = $_GET['id'];
if (empty($id)) {
    header('location: searchInvoice.php');
}
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-10 offset-lg-3">
                ...
                <button class="btn btn-danger float-end mb-5" onclick="window.location = 'searchInvoice.php'" ;>Back</button>
                ...
                <div class="mt-5">
                    ...
                    <table class="table table-hover mt-5">
                        ...
                        <tbody>
                            ...
                            $orders = Database::search("SELECT * FROM `order` WHERE `invoice_id` = '" . $id . "' AND `order_status_id` != '4'  ");
                            $orders_n = $orders->num_rows;
                            ...
                            ?>
                                <tr class="fs-5 p-3 text-center">
                                    <td id="oId"><?php echo ($order_data['id']); ?></td>
                                    <td id="oId"><?php echo ($mobile); ?></td>
                                    <td id="oId"><?php echo ($item); ?></td>
                                    <td id="oId"><?php echo ($order_data['qty']); ?></td>
                                    <td id="oId"><?php echo ($order_data['price']); ?></td>
                                    <td id="oId"><?php echo ($order_data['date']); ?></td>
                                </tr>
                            <?php
                            }
                            ?>
                    ...
                    <div class="col-12" style="margin-top: 230px;">
